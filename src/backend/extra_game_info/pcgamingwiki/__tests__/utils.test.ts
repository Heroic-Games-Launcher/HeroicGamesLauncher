...
describe('getPCGamingWikiInfo', () => {
  ...
  test('use cached data', async () => {
    pcGamingWikiInfoStore.set('The Witcher 3', testGameScore)
  ...
  test('cached data outdated', async () => {
    ...
    pcGamingWikiInfoStore.set('The Witcher 3', {
      ...testGameScore,
...
const testGameScore: PCGamingWikiInfo = {
