...
export const getSteamCloudSyncStatus = makeHandlerInvoker('getSteamCloudSyncStatus')
export const runSteamCloudSync = makeHandlerInvoker('runSteamCloudSync')
export const resolveSteamCloudSync = makeHandlerInvoker('resolveSteamCloudSync')
export const listSteamCloudFiles = makeHandlerInvoker('listSteamCloudFiles')
export const handleSteamCloudSyncStatusChanged = frontendListenerSlot('steamCloudSyncStatusChanged')
