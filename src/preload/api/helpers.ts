...
export const focusMainWindow = makeListenerCaller('focusMainWindow')
export const toggleMainWindowFocus = makeListenerCaller('toggleMainWindowFocus')
...
export const getGogDealsRegion = makeHandlerInvoker('getGogDealsRegion')
export const getGogDiscounts = makeHandlerInvoker('getGogDiscounts')
export const getGogWishlist = makeHandlerInvoker('getGogWishlist')
