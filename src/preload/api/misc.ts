...
export const addRestPlugin = makeHandlerInvoker('addRestPlugin')
export const getRestPlugins = makeHandlerInvoker('getRestPlugins')
export const refreshRestLibrary = makeHandlerInvoker('refreshRestLibrary')
