...
export const getLegendaryAccounts = makeHandlerInvoker('getLegendaryAccounts')
export const switchLegendaryAccount = makeHandlerInvoker('switchLegendaryAccount')
export const clearLegendaryWebSession = makeHandlerInvoker('clearLegendaryWebSession')
export const removeLegendaryAccount = makeHandlerInvoker('removeLegendaryAccount')
