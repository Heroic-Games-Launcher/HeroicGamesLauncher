...
export const installThirdPartyLauncher = makeHandlerInvoker('installThirdPartyLauncher')
export const cancelThirdPartyLauncherInstall = makeHandlerInvoker('cancelThirdPartyLauncherInstall')
