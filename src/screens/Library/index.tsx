...
window.onload = () => {
  ipcRenderer.on('recent-games-changed', (e, recentGamesArray) => {
    // How to get recent games:
    // let recentGames: any = localStorage.getItem('games.recent')
    // recentGames = JSON.parse(recentGames)
    localStorage.setItem('games.recent', JSON.stringify(recentGamesArray))
  })
}
