...
interface SyncIPCFunctions {
  ...
  setSteamIntegrationEnabled: (game: Game, enabled: boolean) => void
...
interface AsyncIPCFunctions {
  ...
  getExtraInfo: (game: Game, lang?: string) => Promise<ExtraInfo | null>
  ...
  getSteamIntegrationEnabled: (game: Game) => boolean
  isLoggedIn: () => boolean
