...
import { ReactComponent as DownIcon } from '/src/frontend/assets/down-icon.svg'
import {
  FavouriteGame,
  GameStatus,
  HiddenGame,
...
import { ReactComponent as PlayIcon } from '/src/frontend/assets/play-icon.svg'
import { ReactComponent as SettingsIcon } from '/src/frontend/assets/settings-sharp.svg'
import { ReactComponent as StopIcon } from '/src/frontend/assets/stop-icon.svg'
import { ReactComponent as StopIconAlt } from '/src/frontend/assets/stop-icon-alt.svg'
import { getProgress, install, launch, sendKill } from '/src/frontend/helpers'
import { useTranslation } from 'react-i18next'
import ContextProvider from '/src/frontend/state/ContextProvider'
import fallbackImage from '/src/frontend/assets/fallback-image.jpg'
import { updateGame } from '/src/frontend/helpers/library'
import { CachedImage, SvgButton } from '/src/frontend/components/UI'
...
import UninstallModal from '/src/frontend/components/UI/UninstallModal'
