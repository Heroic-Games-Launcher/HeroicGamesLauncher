...
export default function EpicAccountsManager({
  ...
  async function handleRemove(account: LegendaryAccount) {
    ...
    const confirmed = window.confirm(
      t(
        'login.epic_accounts.remove_confirm',
  ...
  return (
    <div className="epicAccountsManager">
      <div className="epicAccountsHeader">
        <span>{t('login.epic_accounts.title', 'Epic Accounts')}</span>
        <button
        ...
        >
          {t('login.epic_accounts.add', 'Add Account')}
        </button>
      </div>
              ...
              <div className="epicAccountRow" key={account.account_id}>
                <div className="epicAccountDetails">
                  ...
                  <div className="epicAccountMeta">
                    {isActive
                      ? t('login.epic_accounts.active', 'Active')
                      : t(
                          'login.epic_accounts.last_used',
                          'Last used {{date}}',
                          {
                            date: lastUsed
                          }
                ...
                <div className="epicAccountActions">
                  {!isActive && (
                    ...
                    >
                      {isCurrentAccountBusy
                        ? t('login.epic_accounts.switching', 'Switching')
                        : t('login.epic_accounts.switch', 'Switch')}
                    </button>
                  )}
                  <button
                  ...
                  >
                    {t('login.epic_accounts.remove', 'Remove')}
                  </button>
                </div>
              </div>
            )
