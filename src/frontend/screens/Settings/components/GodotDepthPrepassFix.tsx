    ...
    <div className="toggleRow">
      ...
      <InfoIcon
        text={t(
          ...
          'Forces Godot depth pre-pass to be enabled. Fixes invisible/transparent character and monster sprites in games like Cassette Beasts on Apple Silicon Macs.'
        )}
      />
    </div>
  )
