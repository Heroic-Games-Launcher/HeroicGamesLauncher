    ...
    if (showValveProton) {
      ...
      showDialogModal({
        ...
        message: t(
          ...
          "We recommend custom Proton forks (GE-Proton, Proton-CachyOS, etc.) to be used with Heroic because Valve's Proton builds lack winetricks and umu-protonfixes. You can still use them if you want."
        ),
        buttons: [
          {
            text: t(
